...
WHERE [dbo].[Patient].[id] = @PATIENT_ID AND [dbo].[Patient].[id] = [dbo].[Personnel].[id] AND [dbo].[Patient].[id] = [dbo].[PaymentRecord].[patientID] 
go
...
WHERE [dbo].[Dentist].[id] = @DENTIST_ID AND [dbo].[Personnel].[id] = [dbo].[Dentist].[id]
go
...
WHERE [dbo].[Session].[dentistID] = @DENTIST_ID AND [dbo].[Session].[id] = [dbo].[TreatmentSession].[id]
go
